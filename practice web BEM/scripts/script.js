document.addEventListener("DOMContentLoaded", function() {
    const listButton = document.querySelector('.list__mobile');
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const searchInput = document.getElementById("search-block__input");
    const searchIconM = document.getElementById("search__mobile");
    const searchContainerM = document.getElementById("search-container__mobile");
    const escapeButtonM = document.getElementById("escape__mobile");
    const searchInputM = document.getElementById("search-block-mobile__input");
